...
func TestErrorResponses(t *testing.T) {
	...
	cases := []struct {
		...
		{"share phone without token", api, "POST", "/api/v1/me/phone", "", `{}`, 401, "unauthorized"},
		{"share phone broken JSON", api, "POST", "/api/v1/me/phone", fresh, `{"phone":`, 422, "invalid_input"},
		{"share phone without hash", api, "POST", "/api/v1/me/phone", fresh, `{"phone":"+79991234567","auth_date":"1"}`, 422, "invalid_contact"},
		{"hide phone without token", api, "DELETE", "/api/v1/me/phone", "", "", 401, "unauthorized"},
