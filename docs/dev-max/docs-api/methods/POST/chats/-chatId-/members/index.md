...
- **`failed_user_ids`** — integer[] · Nullable · optional

  ID пользователей, которых не удалось добавить в групповой чат

- **`failed_user_details`** — FailedUserDetails[] · Nullable · optional
