...
[Source](https://github.com/max-messenger/max-ui/tree/main/src/compositions/Profile) · [Issues](https://github.com/max-messenger/max-ui/issues) · [Storybook](https://max-messenger.github.io/max-ui/?path=/docs/compositions-profile--docs)
...
Источник: <https://dev.max.ru/ui/compositions/Profile>
