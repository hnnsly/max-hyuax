...
3. Создайте экземпляр класса Bot и передайте [токен бота](../bots-create/manage.md#Получение%20токена%20бота) из его настроек (карточки) в конструктор через переменные окружения. Можно использовать библиотеку [dotenv](https://www.npmjs.com/package/dotenv)
...
Чтобы выделить в сообщениях важную информацию, используйте разные способы оформления текста — **жирный шрифт**, *курсив*, [ссылки](https://dev.max.ru/) и другое. Есть два типа форматирования — Markdown и HTML. Подробнее — [в разделе API о способах форматирования](../../../docs-api/index.md#Форматирование%20текста%20в%20сообщениях)
...
// Далее мы можем отправить клавиатуру пользователю в сообщении, например, при вызове команды старт
bot.command('start', (ctx: Context) => {
  ctx.reply('Добро пожаловать!', {attachments: [keyboard]})
});
```

Как работать с клавиатурой через API, читайте в [разделе «Клавиатура для чат-бота»](../../../docs-api/index.md#Клавиатура%20для%20чат-бота)
