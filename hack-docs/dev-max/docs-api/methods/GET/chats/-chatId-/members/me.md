...
Возвращает информацию о членстве бота в групповом чате или канале, общую информацию о нём, а также список [доступных прав доступа](../../../../POST/chats/-chatId-/members/admins.md#Доступные%20права%20администратора). Бот идентифицируется с помощью токена доступа
