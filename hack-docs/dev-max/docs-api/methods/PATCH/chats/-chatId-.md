...
- **`icon`** — object PhotoAttachmentRequestPayload · Nullable · optional
...
- **`pin`** — string · Nullable · optional

  ID сообщения для закрепления в чате или канале. Чтобы удалить закреплённое сообщение, используйте метод [`DELETE /chats/{chatId}/pin`](../../DELETE/chats/-chatId-/pin.md)

- **`notify`** — boolean · Nullable · optional
...
- **`dialog_with_user`** — object [UserWithPhoto](../../../objects/UserWithPhoto.md) · Nullable · optional
...
- **`pinned_message`** — object [Message](../../../objects/Message.md) · Nullable · optional
