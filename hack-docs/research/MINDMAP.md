...
| УК видит масштаб и меняет статус | есть: очередь по срочности с фильтрами, метрики, фото-пруф; в боте очередь, смена статуса и метрики (ADR-019) |
| PDF для эскалации в ГЖИ | есть: черновик обращения по подписанной ссылке, PDF-реестр дома |
| Роли председателя совета и района, проверка ремонта жителями | есть: совет дома и опросы, кабинет района, «Починили» и «Не починили» (ADR-017); в боте меню по роли |
...
| Карта домов, голос, рейтинг УК, коллективное обращение | в работе по [GEN_V3_PLAN](../GEN_V3_PLAN.md) |
