...
- **Этап:** MVP собран. Ядро, все Should и материалы к сдаче готовы в коде и в `docs/`.
  - По [GEN_V2_PLAN](GEN_V2_PLAN.md) сделаны части 0–5: шлифовка, подтверждение ремонта жителями, телефон для мастера, кабинет района.
  - Впереди импорт домов с геокодером и председатель совета.
...
| Файл | Когда |
|---|---|
| `adr/016` геокодер и лицензии открытых данных; дополнение ADR-017 про председателя совета | части 6–7 [GEN_V2_PLAN](GEN_V2_PLAN.md) |
